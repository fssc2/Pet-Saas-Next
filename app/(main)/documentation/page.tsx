...
const Documentation = () => {
    return (
        <div className="card docs">
            ...
            <p>
                Freya is an application template for Next.js based on the popular{' '}
                ...
                . Current versions are Next v13, React v18 with PrimeReact v9.
            </p>
            ...
            <p>
                Next step is running the application using the start script and navigate to <b>http://localhost:3000/</b> to view the application. That is it, you may now start with the development of your application using the Freya template.
            </p>
            ...
            <h5>Dependencies</h5>
            <p>Dependencies of Freya are listed below and needs to be defined at package.json.</p>
...
`}
            ...
            <h5>Structure</h5>
            <p>Freya consists of a couple folders, demos and core has been separated so that you can easily remove what is not necessary for your application.</p>
            <p>
                There are three{' '}
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        <link
          id="theme-link"
          href={\`/theme/theme-light/teal/theme.css\`}
          rel="stylesheet"
        ></link>
      </head>
      <body>
    ...
    const model = [
        {
            ...
            <h4>Theme</h4>
            <p>
                Freya provides 20 PrimeReact themes out of the box. Setup of a theme is simple by including the CSS of the theme to your bundle that are located inside <span className="text-primary font-medium">public/theme/</span>
