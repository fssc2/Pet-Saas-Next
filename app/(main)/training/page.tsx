                                ...
                                <div className="flex align-items-start">
                                    <div className="ml-0 flex-1 pb-0">
                                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                            ...
                                            <span className="font-bold text-700">43%</span>
                                        </div>

                                        <div className="flex align-items-center justify-content-between" style={{ justifyContent: 'flex-end', marginTop: '14px' }}>
                                            <span className="text-xs text-500">2 Occupied</span>
                                            <span className="text-xs text-500">5 Available</span>
                                            {/* <span className="font-bold text-700">
                                                12/12
                                            </span> */}
                                        </div>
                            ...
                            <div className="shadow-2 surface-card border-round p-3 h-full">
                                <div className="flex align-items-start">
                                    <div className="ml-0 flex-1 pb-0">
                                        ...
                                        <div className="flex align-items-center justify-content-between" style={{ justifyContent: 'flex-end', marginTop: '14px' }}>
                                            <span className="text-xs text-500">3 Requests</span>
                                            <span className="text-xs text-500">2 Wait List</span>
                                        </div>
